...
import com.trafilea.coffeeshop.cart.infra.usecase.CreateOrderImpl;
...
public class InfraConfiguration {
    ...
    @Bean
    public CreateOrder createOrder(CartRepository cartRepository) {
        return new CreateOrderImpl(cartRepository);
    }
